...
exports.default = {
    Query: {
        seeProfile: api_utils_1.protectedResolver(function (_, _a) {
            var id = _a.id;
    ...
    TotalFollowNum: {
        count: function (parent, _, __, info) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                id = parent.id;
                from = info.path.prev.key;
                return [2 /*return*/, client_1.default.user.count({
                        where: (_a = {},
