...
exports.default = {
    Mutation: {
        toggleFollow: user_utils_1.protectedResolver(function (_, _a, _b) {
            var targetId = _a.id;
            var loggedUser = _b.loggedUser;
            return __awaiter(void 0, void 0, void 0, function () {
                var isExist, isFollowing, error_1;
                var _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            else if (targetId === (loggedUser === null || loggedUser === void 0 ? void 0 : loggedUser.id)) {
                        ...
                        case 2:
                            isFollowing = _d.sent();
                            return [4, client_1.default.user.update({
                                    where: { id: loggedUser === null || loggedUser === void 0 ? void 0 : loggedUser.id },
                                    data: {
                                        following: (_c = {},
                                            _c[isFollowing ? "disconnect" : "connect"] = { id: targetId },
                                            _c),
                                    },
                                })];
                        case 3:
